  ...
  <div>
    ...
    <v-card>
      <v-img
        ...
        height="250"
      />
      <v-card-title> MATEMATICA 6TO GRADO </v-card-title>
      <v-card-text>
...
<script>
import {
  mdiMenuUp, mdiAccountOutline, mdiCurrencyUsd, mdiTrendingUp, mdiDotsVertical, mdiLabelOutline,
} from '@mdi/js'
...
export default {
  ...
  setup() {
    ...
    const resolveStatisticsIconVariation = data => {
      if (data === 'Promedio 1') return { icon: mdiTrendingUp, color: 'primary' }
      if (data === 'Promedio 2') return { icon: mdiTrendingUp, color: 'primary' }
      if (data === 'Promedio 3') return { icon: mdiTrendingUp, color: 'primary' }
